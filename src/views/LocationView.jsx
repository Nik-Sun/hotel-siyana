    ...
    return (
        <section className="view section section-alt">
            <div className="container">
                <h2>Къде се намира хотел Siana House</h2>

                <div className="location-layout">
                    <div className="location-details">
                        <h3>Спокойна локация в Равда</h3>
                        <p>
                            Семеен хотел Siana House се намира в Равда – спокойно курортно
                    ...
                    <div className="location-map">
                        ...
                        <iframe
                            title="Карта – Семеен хотел Siana House, Равда"
